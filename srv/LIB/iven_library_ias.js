...
module.exports = {
    getIASUser: async function () {
        ...
        // queryResult = await connection.run( SELECT.from`${connection.entities['VENDOR_PORTAL.MASTER_IAS_USER']}`);
    ...
    _sendToIAS: async function (oIASBodyPayload) {
        try {
            ...
            await IASConnection.send('PATCH', '/Groups/e11c19d1-0673-4deb-89dd-8def1326a18a',
    ...
    UpdateVendorEmailIdIAS: async function (sapVendoCode, newEmaiID) {
