...
// 			// . Your approved registration does not entitle you to be invited to any/all procurement processes. ${oEmailData.EntityDesc}
// 			//  reserve the right to select the participants based on their discretion.`
// 			var Emailbody1 = `Dear Valued Recipient,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>Your company, ${oEmailData.SupplierName} is invited to update registration with ${oEmailData.EntityDesc}  
// 		 as a vendor.<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>   
// 		In order to perform any business with us, you need to complete this registration in full 
// 		using the link 
...
// 		Upon submission, your registration request will be reviewed by relevant teams. We may seek additional information as part of this process.
// 		<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
// 	<u>Once approved, you may be invited to future procurement processes by ${oEmailData.EntityDesc}. 
// 	Your approved registration does not entitle you to be invited to any/all procurement processes. ${oEmailData.EntityDesc}
// 	 reserve the right to select the participants based on their discretion.</u><br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
// 		Should you have any questions, please do not hesitate to reach out to us via email at <a href=${sClientContactEmail}
// 		>${sClientContactEmail}</a><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
// 		Regards,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
// 		Vendor Management Team`;

// 		oEmailContent.emailBody = `<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;>"Dear Valued Recipient,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br> Dear Valued Recipient,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>Your company, ${oEmailData.SupplierName} is invited to update registration with ${oEmailData.EntityDesc}  
// 		as a vendor.<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>   
// 	   In order to perform any business with us, you need to complete this registration in full 
// 	   using the link 
// 	   <a href=${sLink_Portal_LoginAccess}
...
// 	   >${sClientContactEmail}</a><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
// 	   Regards,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
// 	   Vendor Management Team</p>`;

// 		}   

// 		oEmailContent.emailBody = `${oEmailContent.emailBody}<br><br><p style=font-family:Arial, Helvetica, sans-serif;font-size:9px;color:black>Please note that this email has been generated automatically.</p><br>`;
...
// 	},
	...
	getEmailContent: async function (connection,sAction, sAppType, oEmailData, iStatus) {
		...
		var linkcontent;
		var sRows = "";  
		let sEmailContent=await SELECT .from('VENDOR_PORTAL_MASTER_EMAIL_CONTENT') .where({APP_TYPE:sAppType,ACTION:sAction});
		if (sAppType === "REQUEST") {
			var supEmailContent = {};
			if (sAction === "CREATE") {
				...
				oEmailContent.subject = eval('`'+sEmailContent[0].SUBJECT+'`');
				    
				oEmailContent.emailBody = eval('`'+sEmailContent[0].BODY+'`');      
			   ...
			   oEmailContent.emailBody = eval('`'+sEmailContent[0].BODY+'`'); 
				...
				if (req_Type === "1" || req_Type === "2" || req_Type === "3" || req_Type === "6") {
					...
					oEmailContent.emailBody = `We kindly ${msg} invite your company ${oEmailData.SupplierName}, to register as a vendor with
						...
						Once you submit your registration, our dedicated teams will thoroughly review and approve your request. Additional information may be requested during this process.
						<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
						Upon successful approval, you may receive future invitations to participate in procurement processes conducted by 
						${oEmailData.EntityDesc}.<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
						Please note that your approved registration does not guarantee automatic invitation to all procurement processes. ${oEmailData.EntityDesc}
						 retains the right to select participants at its own discretion.
						<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
				...
				Emailbody = "Dear Vendor,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>";
				oEmailContent.emailBody = `<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;>
				Dear Vendor,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>
				We kindly ${msg} invite your company ${oEmailData.SupplierName}, to register as a vendor with
				${oEmailData.EntityDesc}.
				<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
				To engage in any business activities with ${oEmailData.EntityDesc}
				, it is mandatory for you to complete the registration form provided in 
			...
			if (sAction === "CREATE" || sAction === "APPROVE" || sAction === "RESEND" || sAction === "INTERNALREQ" || sAction === "QUICK_REG") {
				...
				oEmailContent.emailBody = `${greetingsTo}<br><br>
				Request No. ${oEmailData.ReqNo} for ${sRequestTypeText} Vendor Registration of <span style="text-transform:uppercase">
				${oEmailData.SupplierName}</span> has been ${sActionTypeText} and is currently pending for ${oEmailData.NextApproverRole} approval.<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>       
					${linkcontent}
					<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
					Should you have any questions, please do not hesitate to reach out to us via email at 
					<strong><a href=${sClientContactEmail}>${sClientContactEmail}</a></strong> <p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
				...
				Request No. ${oEmailData.ReqNo} for ${sRequestTypeText}
				Vendor self Registration as <span style="text-transform:uppercase">
				${oEmailData.SupplierName}</span> has been ${sActionTypeText} and is currently pending for approval.<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>
				...
				var sSupplierName = `for <span style="text-transform:uppercase">
					${oEmailData.SupplierName}
					</span> has been rejected.<br><p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>`
			...
			oEmailContent.emailBody = eval('`'+sEmailContent[0].BODY+'`');
						...
						if (sAction === "BEFORE") {
							...
							oEmailContent.emailBody =
								`Dear Valued Recipient,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>Some of your attachments (documents/certificates) uploaded in Vendor Registration as <span style="text-transform:uppercase">
								${oEmailData.SupplierName} </span> are set to expire in <strong>7 days</strong>.<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>Please update the registration form with the renewed documents for the following attacments soon by <strong>${getLongDate(deadline)}
								</strong>:<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>`;
							...
							oEmailContent.emailBody =
								`Dear Valued Recipient,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>Some of your attachments (documents/certificates) uploaded in Vendor Registration as <span style="text-transform:uppercase">
								${oEmailData.SupplierName}</span> are set to expire <strong>today</strong>.<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>Please update the registration form with the renewed documents for the following attachments in 30 days.
								Else your vendor registration may get deactivated on
								<strong>${getLongDate(deadline)}</strong>.<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br>`;
							...
							oEmailContent.subject = `${sClientShortName} registration form attachments expiring in 20 days.`;
							...
							oEmailContent.emailBody +=
								`Dear Valued Recipient,<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>Vendor <span style="text-transform:uppercase">"
								${oEmailData.SupplierName}
								</span> missed updating the expired attachments (documents/certificates) uploaded in Vendor Registration </span> even after sending final notification as reminder for the following attachments:<p style=font-family:Arial, Helvetica, sans-serif;font-size:11px;color:black;><br><br>`;
			...
			for (var i = 0; i < oEmailData.changeDetails.length; i++) {
				var srno=i+1;
				sTableContent += "<TR border:1px solid black;>";
				sTableContent += "<TD border:1px solid black;>" + srno + "</TD>";
				sTableContent += "<TD border:1px solid black;>" + oEmailData.changeDetails[i].CHANGE_TYPE + "</TD>";
				sTableContent += "<TD border:1px solid black;>" + oEmailData.changeDetails[i].OLD_VALUE + "</TD>";
				sTableContent += "<TD border:1px solid black;>" + oEmailData.changeDetails[i].NEW_VALUE + "</TD>";
				sTableContent += "</TR>";
			}
			sTableContent += "</tbody>";
		...
		oEmailContent.emailBody = eval('`'+sEmailContent[0].END_EMAIL_BODY1+'`');
		oEmailContent.emailBody = eval('`'+sEmailContent[0].END_EMAIL_BODY2+'`');           
		return oEmailContent;     
	}
}