...
service addtionalProcessService {
  ...
  action   VendorDataMigration(action : String, reqHeader : many RequestInfo, addressData : many RegFormAddress, contactsData : many RegFormContacts, bankData : many RegFormBanks,userDetails:User_Details)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   returns many String;
