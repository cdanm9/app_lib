...
service addtionalProcessService {
  ...
  action   VendorInternalRequest(action : String, stepNo : Integer, comment : String, srNo : Integer, attachCode : Integer, ndaStatus : String, reqHeader : many RequestInfo, addressData : many RegFormAddress, contactsData : many RegFormContacts, bankData : many RegFormBanks, financeData : many RegFormFinancial, ownersData : many RegFormOwners, prodServData : many RegFormProdServ, capacityData : many RegFormCapacity, customerData : many RegFormCustomers, oemData : many RegFormOEM, discFieldsData : many RegFormDiscInfo, discRelativesData : many RegFormDiscRelatives, discQaCertiData : many RegFormDiscQaCertif, attachmentFieldsData : many RegFormAttachFields, attachmentData : many RegFormAttachments, updatedFields : many String, eventsData : many RegEventsLog, supplierLogData : many RegSupplierLog) returns many String;
  action   VendorDataMigration(action : String, reqHeader : many RequestInfo, addressData : many RegFormAddress, contactsData : many RegFormContacts, bankData : many RegFormBanks)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   returns many String;
  function getDataMigrationConfiguration()                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            returns many String;
  action   DataMigrationConfiguration(action : String, DMFieldConfiguration : many DataMigrationFieldConfiguration, DMLimit : Integer)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                returns many String;
function getBackendAvailability() returns many String;
}
